...
function ContactMe(){
    ...
    return(
    <div id="contact">
    <div class="flex flex-col bg-center bg-cover bg-no-repeat mt-3">
			<div class="grid place-items-center mx-auto p-2 sm:my-auto bg-white rounded-3xl space-y-10">
            <h1 class="text-2xl text-center text-gray-600 font-bold mb-4">Let's connect</h1>

            <div class="md:flex items-center justify-center space-x-3">
